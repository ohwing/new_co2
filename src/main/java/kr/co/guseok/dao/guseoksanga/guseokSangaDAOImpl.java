...
public class guseokSangaDAOImpl implements guseokSangaDAO{
	...
	public void updateSangaNullImage(guseokSangaVO guseokSangaVo) {
		// TODO Auto-generated method stub
		sqlSession.update(namespace+".updateSangaNullImage", guseokSangaVo);
	}

	@Override
	public void updateSangaMemberStore(guseokSangaVO guseokSangaVo) {
		// TODO Auto-generated method stub
		sqlSession.update(namespace+".updateSangaMemberStore", guseokSangaVo);
	}

	@Override
	public List<guseokSangaVO> getSanga() {
		// TODO Auto-generated method stub
		return sqlSession.selectList(namespace+".getSanga");
	}
