				...
				<form action="/board/searchlist" method="get">
				 ...
				 <div class="form-group row1">
				    ...
				    <div class="col-sm-12 col-md-10" style="margin-bottom: 3px;">
				      <input type="text" class="form-control form-control-lg" id="list_tour_search" name="list_tour_search" placeholder="관광지를 선택해주세요." readonly="readonly">
				    </div>
